...
INSERT INTO "post" (id, slug, title, description, imageURL, authorID, isEdited, createDate, modifiedDate)
VALUES
-- Painting Category
    ('1', 'sunset-landscape', 'Sunset Landscape', 'A beautiful sunset landscape painting.', '/uploads/banner.4.jpg', '1', false,  "2023-06-10 19:59:44",  "2023-06-10 19:59:44"),
    ('2', 'abstract-expression', 'Abstract Expression', 'An abstract expressionist painting with bold colors.', '/uploads/banner.3.jpg', '2', false,  "2023-04-27 03:39:42",  "2023-04-27 03:39:42"),
-- Sculpture Category
    ('11', 'bronze-sculpture', 'Bronze Sculpture', 'A classical bronze sculpture of a figure.', '/uploads/banner.2.jpg', '3', false,  "2023-01-26 21:14:26",  "2023-01-26 21:14:26"),
    ('12', 'modern-sculpture', 'Modern Sculpture', 'A contemporary abstract sculpture made from metal and wood.', '/uploads/banner.1.jpg', '4', false,  "2023-08-01 04:55:25",  "2023-08-01 04:55:25"),
-- Photography Category
    ('21', 'cityscape-at-night', 'Cityscape at Night', 'A stunning cityscape photograph captured at night.', '/uploads/banner.4.jpg', '5', false,  "2023-04-23 04:40:53",  "2023-04-23 04:40:53"),
    ('22', 'nature-close-up', 'Nature Close-up', 'A macro photograph of a flower in nature.', '/uploads/banner.3.jpg', '1', false,  "2023-02-16 19:52:49",  "2023-02-16 19:52:49"),
-- Digital Art Category
    ('31', 'digital-painting', 'Digital Painting', 'A digital painting created using a graphics tablet.', '/uploads/banner.2.jpg', '1', false,  "2023-06-04 15:24:12",  "2023-06-04 15:24:12"),
    ('32', 'sci-fi-concept', 'Sci-Fi Concept Art', 'A concept art of a futuristic city in a sci-fi world.', '/uploads/banner.1.jpg', '1', false,  "2023-08-02 20:18:47",  "2023-08-02 20:18:47"),
-- Drawing Category
    ('41', 'charcoal-portrait', 'Charcoal Portrait', 'A realistic charcoal portrait of a person.', '/uploads/banner.4.jpg', '2', false,  "2023-04-17 15:47:47",  "2023-04-17 15:47:47"),
    ('42', 'ink-sketch', 'Ink Sketch', 'An ink sketch of a cityscape.', '/uploads/banner.3.jpg', '2', false,  "2023-06-03 17:01:39",  "2023-06-03 17:01:39"),
-- Mixed Media Category
    ('51', 'collage-art', 'Collage Art', 'A collage artwork combining various materials.', '/uploads/banner.2.jpg', '5', false,  "2023-06-04 05:23:54",  "2023-06-04 05:23:54"),
    ('52', 'assemblage', 'Assemblage', 'An assemblage art piece created from found objects.', '/uploads/banner.1.jpg', '4', false,  "2023-01-24 22:35:27",  "2023-01-24 22:35:27"),
-- Printmaking Category
    ('61', 'linocut-print', 'Linocut Print', 'A linocut print of a nature scene.', '/uploads/banner.4.jpg', '4', false,  "2023-03-28 03:03:30",  "2023-03-28 03:03:30"),
    ('62', 'etching', 'Etching', 'An etching print with intricate details.', '/uploads/banner.3.jpg', '4', false,  "2022-09-20 09:12:45",  "2022-09-20 09:12:45"),
-- Ceramics Category
    ('71', 'porcelain-vase', 'Porcelain Vase', 'A delicate porcelain vase with intricate patterns.', '/uploads/banner.2.jpg', '3', false,  "2022-12-01 15:38:42",  "2022-12-01 15:38:42"),
    ('72', 'stoneware-sculpture', 'Stoneware Sculpture', 'A stoneware sculpture of an animal.', '/uploads/banner.1.jpg', '4', false,  "2023-08-06 09:34:15",  "2023-08-06 09:34:15"),
-- Installation Art Category
    ('81', 'interactive-installation', 'Interactive Installation', 'An interactive art installation involving lights and sound.', '/uploads/banner.4.jpg', '5', false,  "2023-01-08 02:16:15",  "2023-01-08 02:16:15"),
    ('82', 'sculptural-installation', 'Sculptural Installation', 'A large-scale sculptural installation in a public space.', '/uploads/banner.3.jpg', '4', false,  strftime('%Y-%m-%d %H:%M:%S', datetime('now')),  strftime('%Y-%m-%d %H:%M:%S', datetime('now'))),
-- Performance Art Category
    ('91', 'live-art-performance', 'Live Art Performance', 'A live art performance involving movement and expression.', '/uploads/banner.2.jpg', '1', false,  strftime('%Y-%m-%d %H:%M:%S', datetime('now')),  strftime('%Y-%m-%d %H:%M:%S', datetime('now'))),
    ('92', 'body-painting-show', 'Body Painting Show', 'A body painting performance with intricate designs.', '/uploads/banner.1.jpg', '4', false,  strftime('%Y-%m-%d %H:%M:%S', datetime('now')),  strftime('%Y-%m-%d %H:%M:%S', datetime('now')));
